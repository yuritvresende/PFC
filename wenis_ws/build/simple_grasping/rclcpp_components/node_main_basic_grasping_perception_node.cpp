...
#define NODE_MAIN_LOGGER_NAME "basic_grasping_perception_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbasic_grasping_perception.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<simple_grasping::BasicGraspingPerception>";
