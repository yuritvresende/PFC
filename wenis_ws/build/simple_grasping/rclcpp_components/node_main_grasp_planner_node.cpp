...
#define NODE_MAIN_LOGGER_NAME "grasp_planner_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libgrasp_planner.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<simple_grasping::GraspPlannerNode>";
