...
bool robotiq_85_msgs__msg__gripper_stat__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robotiq_85_msgs.msg._gripper_stat.GripperStat", full_classname_dest, 45) == 0);
  }
  robotiq_85_msgs__msg__GripperStat * ros_message = _ros_message;
  {  // header
  ...
  {  // requested_position
    ...
    assert(PyFloat_Check(field));
    ros_message->requested_position = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // current
...
{
  /* NOTE(esteve): Call constructor of GripperStat */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("robotiq_85_msgs.msg._gripper_stat");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GripperStat");
  ...
  {  // requested_position
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->requested_position);
    {
