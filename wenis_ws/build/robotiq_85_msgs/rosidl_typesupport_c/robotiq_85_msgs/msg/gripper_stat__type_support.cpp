...
static const _GripperStat_type_support_symbol_names_t _GripperStat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robotiq_85_msgs, msg, GripperStat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robotiq_85_msgs, msg, GripperStat)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robotiq_85_msgs, msg, GripperStat)() {
  return &::robotiq_85_msgs::msg::rosidl_typesupport_c::GripperStat_message_type_support_handle;
}
