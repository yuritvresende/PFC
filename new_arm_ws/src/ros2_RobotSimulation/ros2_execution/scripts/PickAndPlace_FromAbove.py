...
def pick_and_place(initial_angles, box_size, target_position, final_position):
    ...
    with open('/home/yuritvr/PFC/new_arm_ws/src/ros2_RobotSimulation/ros2_execution/programs/pick_and_place.txt', 'w') as arquivo:  # Mudei para 'a' para adicionar sem sobrescrever
        pass
        arquivo.write(f"{{'action': 'MoveJ', 'value': {{'joint1': {round(new_init[0], 2)}, 'joint2': {round(new_init[1], 2)}, 'joint3': {round(new_init[2], 2)}, 'joint4': {round(new_init[3], 2)}, 'joint5': {round(new_init[4], 2)}, 'joint6': {round(new_init[5], 2)}}}, 'speed': 1.0}}\n")
    ...
    with open('/home/yuritvr/PFC/new_arm_ws/src/ros2_RobotSimulation/ros2_execution/programs/pick_and_place.txt', 'a') as arquivo:
        arquivo.write(f"{{'action': 'MoveJ', 'value': {{'joint1': {round(new_init[0], 2)}, 'joint2': {round(new_init[1], 2)}, 'joint3': {round(new_init[2], 2)}, 'joint4': {round(new_init[3], 2)}, 'joint5': {round(new_init[4], 2)}, 'joint6': {round(new_init[5], 2)}}}, 'speed': 1.0}}\n")
    ...
    with open('/home/yuritvr/PFC/new_arm_ws/src/ros2_RobotSimulation/ros2_execution/programs/pick_and_place.txt', 'a') as arquivo:
        arquivo.write(f"{{'action': 'MoveJ', 'value': {{'joint1': {round(pick_position[0], 2)}, 'joint2': {round(pick_position[1], 2)}, 'joint3': {round(pick_position[2], 2)}, 'joint4': {round(pick_position[3], 2)}, 'joint5': {round(pick_position[4], 2)}, 'joint6': {round(pick_position[5], 2)}}}, 'speed': 1.0}}\n")
    ...
    with open('/home/yuritvr/PFC/new_arm_ws/src/ros2_RobotSimulation/ros2_execution/programs/pick_and_place.txt', 'a') as arquivo:
        arquivo.write("{'action': 'Attach', 'value': {'object': 'box', 'endeffector': 'EE_egp64'}}\n")
        arquivo.write("{'action': 'GripperClose'}\n")   
    ...
    with open('/home/yuritvr/PFC/new_arm_ws/src/ros2_RobotSimulation/ros2_execution/programs/pick_and_place.txt', 'a') as arquivo:
        arquivo.write("{'action': 'MoveJ', 'value': {'joint1': 0.0, 'joint2': 0.0, 'joint3': 0.0, 'joint4': 0.0, 'joint5': 90.0, 'joint6': 45.0}, 'speed': 1.0}\n")
    ...
    with open('/home/yuritvr/PFC/new_arm_ws/src/ros2_RobotSimulation/ros2_execution/programs/pick_and_place.txt', 'a') as arquivo:
        arquivo.write(f"{{'action': 'MoveJ', 'value': {{'joint1': {round(place_position[0], 2)}, 'joint2': {round(place_position[1], 2)}, 'joint3': {round(place_position[2], 2)}, 'joint4': {round(place_position[3], 2)}, 'joint5': {round(place_position[4], 2)}, 'joint6': {round(place_position[5], 2)}}}, 'speed': 1.0}}\n")
    ...
    with open('/home/yuritvr/PFC/new_arm_ws/src/ros2_RobotSimulation/ros2_execution/programs/pick_and_place.txt', 'a') as arquivo:
        arquivo.write(f"{{'action': 'MoveJ', 'value': {{'joint1': {round(leave_position[0], 2)}, 'joint2': {round(leave_position[1], 2)}, 'joint3': {round(leave_position[2], 2)}, 'joint4': {round(leave_position[3], 2)}, 'joint5': {round(leave_position[4], 2)}, 'joint6': {round(leave_position[5], 2)}}}, 'speed': 1.0}}\n")
        arquivo.write("{'action': 'GripperOpen'}\n")
        arquivo.write("{'action': 'Detach', 'value': {'object': 'box'}}\n")
        arquivo.write("{'action': 'MoveJ', 'value': {'joint1': 0.0, 'joint2': 0.0, 'joint3': 0.0, 'joint4': 0.0, 'joint5': 0.0, 'joint6': 0.0}, 'speed': 1.0}\n")
