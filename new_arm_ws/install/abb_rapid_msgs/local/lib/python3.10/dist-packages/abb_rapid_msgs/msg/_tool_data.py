...
class Metaclass_ToolData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from abb_rapid_msgs.msg import LoadData
            if LoadData.__class__._TYPE_SUPPORT is None:
                LoadData.__class__.__import_type_support__()
...
class ToolData(metaclass=Metaclass_ToolData):
    ...
    _fields_and_field_types = {
        'robhold': 'boolean',
        'tframe': 'abb_rapid_msgs/Pose',
        'tload': 'abb_rapid_msgs/LoadData',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['abb_rapid_msgs', 'msg'], 'Pose'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['abb_rapid_msgs', 'msg'], 'LoadData'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from abb_rapid_msgs.msg import Pose
        self.tframe = kwargs.get('tframe', Pose())
        from abb_rapid_msgs.msg import LoadData
        self.tload = kwargs.get('tload', LoadData())
    ...
    def __eq__(self, other):
        ...
        if self.robhold != other.robhold:
            return False
        if self.tframe != other.tframe:
            return False
        if self.tload != other.tload:
            return False
        return True
    ...
    @builtins.property
    def tframe(self):
        """Message field 'tframe'."""
        return self._tframe

    @tframe.setter
    def tframe(self, value):
        if __debug__:
            from abb_rapid_msgs.msg import Pose
            assert \
                isinstance(value, Pose), \
                "The 'tframe' field must be a sub message of type 'Pose'"
        self._tframe = value
    ...
    @tload.setter
    def tload(self, value):
        if __debug__:
            from abb_rapid_msgs.msg import LoadData
            assert \
                isinstance(value, LoadData), \
                "The 'tload' field must be a sub message of type 'LoadData'"
        self._tload = value
