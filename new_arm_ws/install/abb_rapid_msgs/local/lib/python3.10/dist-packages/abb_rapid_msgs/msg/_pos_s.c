...
bool abb_rapid_msgs__msg__pos__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abb_rapid_msgs.msg._pos.Pos", full_classname_dest, 27) == 0);
  }
  abb_rapid_msgs__msg__Pos * ros_message = _ros_message;
  {  // x
...
PyObject * abb_rapid_msgs__msg__pos__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("abb_rapid_msgs.msg._pos");
