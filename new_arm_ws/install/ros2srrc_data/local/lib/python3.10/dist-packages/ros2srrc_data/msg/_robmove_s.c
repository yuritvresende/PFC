...
bool ros2srrc_data__msg__robmove__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2srrc_data.msg._robmove.Robmove", full_classname_dest, 34) == 0);
  }
  ros2srrc_data__msg__Robmove * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of Robmove */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2srrc_data.msg._robmove");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Robmove");
