...
bool ros2srrc_data__msg__xyzypr__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2srrc_data.msg._xyzypr.Xyzypr", full_classname_dest, 32) == 0);
  }
  ros2srrc_data__msg__Xyzypr * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of Xyzypr */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2srrc_data.msg._xyzypr");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Xyzypr");
