...
bool ros2srrc_data__msg__ypr__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2srrc_data.msg._ypr.Ypr", full_classname_dest, 26) == 0);
  }
  ros2srrc_data__msg__Ypr * ros_message = _ros_message;
  {  // yaw
...
{
  /* NOTE(esteve): Call constructor of Ypr */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2srrc_data.msg._ypr");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Ypr");
