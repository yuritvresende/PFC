...
bool ros2srrc_data__msg__joint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2srrc_data.msg._joint.Joint", full_classname_dest, 30) == 0);
  }
  ros2srrc_data__msg__Joint * ros_message = _ros_message;
  {  // joint
...
PyObject * ros2srrc_data__msg__joint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2srrc_data.msg._joint");
