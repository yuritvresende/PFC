...
bool ros2srrc_data__msg__linkattacher__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2srrc_data.msg._linkattacher.Linkattacher", full_classname_dest, 44) == 0);
  }
  ros2srrc_data__msg__Linkattacher * ros_message = _ros_message;
  {  // model1_name
...
{
  /* NOTE(esteve): Call constructor of Linkattacher */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2srrc_data.msg._linkattacher");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Linkattacher");
