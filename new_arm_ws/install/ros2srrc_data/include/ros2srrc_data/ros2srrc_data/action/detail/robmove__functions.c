...
ros2srrc_data__action__Robmove_Goal__init(ros2srrc_data__action__Robmove_Goal * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->type)) {
    ros2srrc_data__action__Robmove_Goal__fini(msg);
    return false;
  }
  // speed
  // x
...
ros2srrc_data__action__Robmove_Goal__create()
{
  ...
  ros2srrc_data__action__Robmove_Goal * msg = (ros2srrc_data__action__Robmove_Goal *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2srrc_data__action__Robmove_Goal));
  bool success = ros2srrc_data__action__Robmove_Goal__init(msg);
  if (!success) {
...
ros2srrc_data__action__Robmove_Goal__Sequence__init(ros2srrc_data__action__Robmove_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_Goal * data = NULL;

  if (size) {
    data = (ros2srrc_data__action__Robmove_Goal *)allocator.zero_allocate(size, sizeof(ros2srrc_data__action__Robmove_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2srrc_data__action__Robmove_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros2srrc_data__action__Robmove_Goal__fini(&data[i - 1]);
      }
...
ros2srrc_data__action__Robmove_Goal__Sequence__fini(ros2srrc_data__action__Robmove_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2srrc_data__action__Robmove_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_Goal__Sequence * array = (ros2srrc_data__action__Robmove_Goal__Sequence *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2srrc_data__action__Robmove_Goal__Sequence__init(array, size);
  if (!success) {
...
ros2srrc_data__action__Robmove_Goal__Sequence__destroy(ros2srrc_data__action__Robmove_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2srrc_data__action__Robmove_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2srrc_data__action__Robmove_Goal__Sequence__are_equal(const ros2srrc_data__action__Robmove_Goal__Sequence * lhs, const ros2srrc_data__action__Robmove_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2srrc_data__action__Robmove_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2srrc_data__action__Robmove_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2srrc_data__action__Robmove_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2srrc_data__action__Robmove_Goal * data =
      (ros2srrc_data__action__Robmove_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2srrc_data__action__Robmove_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2srrc_data__action__Robmove_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2srrc_data__action__Robmove_Goal__copy(
...
ros2srrc_data__action__Robmove_Result__init(ros2srrc_data__action__Robmove_Result * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    ros2srrc_data__action__Robmove_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_Result * msg = (ros2srrc_data__action__Robmove_Result *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2srrc_data__action__Robmove_Result));
  bool success = ros2srrc_data__action__Robmove_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_Result__Sequence__init(ros2srrc_data__action__Robmove_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_Result * data = NULL;

  if (size) {
    data = (ros2srrc_data__action__Robmove_Result *)allocator.zero_allocate(size, sizeof(ros2srrc_data__action__Robmove_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2srrc_data__action__Robmove_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2srrc_data__action__Robmove_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2srrc_data__action__Robmove_Result__Sequence__fini(ros2srrc_data__action__Robmove_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2srrc_data__action__Robmove_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_Result__Sequence * array = (ros2srrc_data__action__Robmove_Result__Sequence *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2srrc_data__action__Robmove_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_Result__Sequence__destroy(ros2srrc_data__action__Robmove_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2srrc_data__action__Robmove_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2srrc_data__action__Robmove_Result__Sequence__are_equal(const ros2srrc_data__action__Robmove_Result__Sequence * lhs, const ros2srrc_data__action__Robmove_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2srrc_data__action__Robmove_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2srrc_data__action__Robmove_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2srrc_data__action__Robmove_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2srrc_data__action__Robmove_Result * data =
      (ros2srrc_data__action__Robmove_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2srrc_data__action__Robmove_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2srrc_data__action__Robmove_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2srrc_data__action__Robmove_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2srrc_data__action__Robmove_Feedback__init(ros2srrc_data__action__Robmove_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->feedback)) {
    ros2srrc_data__action__Robmove_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_Feedback * msg = (ros2srrc_data__action__Robmove_Feedback *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2srrc_data__action__Robmove_Feedback));
  bool success = ros2srrc_data__action__Robmove_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_Feedback__Sequence__init(ros2srrc_data__action__Robmove_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_Feedback * data = NULL;

  if (size) {
    data = (ros2srrc_data__action__Robmove_Feedback *)allocator.zero_allocate(size, sizeof(ros2srrc_data__action__Robmove_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2srrc_data__action__Robmove_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2srrc_data__action__Robmove_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2srrc_data__action__Robmove_Feedback__Sequence__fini(ros2srrc_data__action__Robmove_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2srrc_data__action__Robmove_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_Feedback__Sequence * array = (ros2srrc_data__action__Robmove_Feedback__Sequence *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2srrc_data__action__Robmove_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_Feedback__Sequence__destroy(ros2srrc_data__action__Robmove_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2srrc_data__action__Robmove_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2srrc_data__action__Robmove_Feedback__Sequence__are_equal(const ros2srrc_data__action__Robmove_Feedback__Sequence * lhs, const ros2srrc_data__action__Robmove_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2srrc_data__action__Robmove_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2srrc_data__action__Robmove_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2srrc_data__action__Robmove_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2srrc_data__action__Robmove_Feedback * data =
      (ros2srrc_data__action__Robmove_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2srrc_data__action__Robmove_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2srrc_data__action__Robmove_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2srrc_data__action__Robmove_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2srrc_data__action__Robmove_SendGoal_Request__init(ros2srrc_data__action__Robmove_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ros2srrc_data__action__Robmove_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!ros2srrc_data__action__Robmove_Goal__init(&msg->goal)) {
    ros2srrc_data__action__Robmove_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
ros2srrc_data__action__Robmove_SendGoal_Request__fini(ros2srrc_data__action__Robmove_SendGoal_Request * msg)
{
  ...
  // goal
  ros2srrc_data__action__Robmove_Goal__fini(&msg->goal);
}
...
ros2srrc_data__action__Robmove_SendGoal_Request__are_equal(const ros2srrc_data__action__Robmove_SendGoal_Request * lhs, const ros2srrc_data__action__Robmove_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!ros2srrc_data__action__Robmove_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_SendGoal_Request * msg = (ros2srrc_data__action__Robmove_SendGoal_Request *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2srrc_data__action__Robmove_SendGoal_Request));
  bool success = ros2srrc_data__action__Robmove_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_SendGoal_Request__Sequence__init(ros2srrc_data__action__Robmove_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_SendGoal_Request * data = NULL;

  if (size) {
    data = (ros2srrc_data__action__Robmove_SendGoal_Request *)allocator.zero_allocate(size, sizeof(ros2srrc_data__action__Robmove_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2srrc_data__action__Robmove_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2srrc_data__action__Robmove_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2srrc_data__action__Robmove_SendGoal_Request__Sequence__fini(ros2srrc_data__action__Robmove_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2srrc_data__action__Robmove_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_SendGoal_Request__Sequence * array = (ros2srrc_data__action__Robmove_SendGoal_Request__Sequence *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2srrc_data__action__Robmove_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_SendGoal_Request__Sequence__destroy(ros2srrc_data__action__Robmove_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2srrc_data__action__Robmove_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2srrc_data__action__Robmove_SendGoal_Request__Sequence__are_equal(const ros2srrc_data__action__Robmove_SendGoal_Request__Sequence * lhs, const ros2srrc_data__action__Robmove_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2srrc_data__action__Robmove_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2srrc_data__action__Robmove_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2srrc_data__action__Robmove_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2srrc_data__action__Robmove_SendGoal_Request * data =
      (ros2srrc_data__action__Robmove_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2srrc_data__action__Robmove_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2srrc_data__action__Robmove_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2srrc_data__action__Robmove_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2srrc_data__action__Robmove_SendGoal_Response__init(ros2srrc_data__action__Robmove_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    ros2srrc_data__action__Robmove_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_SendGoal_Response * msg = (ros2srrc_data__action__Robmove_SendGoal_Response *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2srrc_data__action__Robmove_SendGoal_Response));
  bool success = ros2srrc_data__action__Robmove_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_SendGoal_Response__Sequence__init(ros2srrc_data__action__Robmove_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_SendGoal_Response * data = NULL;

  if (size) {
    data = (ros2srrc_data__action__Robmove_SendGoal_Response *)allocator.zero_allocate(size, sizeof(ros2srrc_data__action__Robmove_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2srrc_data__action__Robmove_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2srrc_data__action__Robmove_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2srrc_data__action__Robmove_SendGoal_Response__Sequence__fini(ros2srrc_data__action__Robmove_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2srrc_data__action__Robmove_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_SendGoal_Response__Sequence * array = (ros2srrc_data__action__Robmove_SendGoal_Response__Sequence *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2srrc_data__action__Robmove_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_SendGoal_Response__Sequence__destroy(ros2srrc_data__action__Robmove_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2srrc_data__action__Robmove_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2srrc_data__action__Robmove_SendGoal_Response__Sequence__are_equal(const ros2srrc_data__action__Robmove_SendGoal_Response__Sequence * lhs, const ros2srrc_data__action__Robmove_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2srrc_data__action__Robmove_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2srrc_data__action__Robmove_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2srrc_data__action__Robmove_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2srrc_data__action__Robmove_SendGoal_Response * data =
      (ros2srrc_data__action__Robmove_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2srrc_data__action__Robmove_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2srrc_data__action__Robmove_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2srrc_data__action__Robmove_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2srrc_data__action__Robmove_GetResult_Request__init(ros2srrc_data__action__Robmove_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ros2srrc_data__action__Robmove_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_GetResult_Request * msg = (ros2srrc_data__action__Robmove_GetResult_Request *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2srrc_data__action__Robmove_GetResult_Request));
  bool success = ros2srrc_data__action__Robmove_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_GetResult_Request__Sequence__init(ros2srrc_data__action__Robmove_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_GetResult_Request * data = NULL;

  if (size) {
    data = (ros2srrc_data__action__Robmove_GetResult_Request *)allocator.zero_allocate(size, sizeof(ros2srrc_data__action__Robmove_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2srrc_data__action__Robmove_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2srrc_data__action__Robmove_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2srrc_data__action__Robmove_GetResult_Request__Sequence__fini(ros2srrc_data__action__Robmove_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2srrc_data__action__Robmove_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_GetResult_Request__Sequence * array = (ros2srrc_data__action__Robmove_GetResult_Request__Sequence *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2srrc_data__action__Robmove_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_GetResult_Request__Sequence__destroy(ros2srrc_data__action__Robmove_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2srrc_data__action__Robmove_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2srrc_data__action__Robmove_GetResult_Request__Sequence__are_equal(const ros2srrc_data__action__Robmove_GetResult_Request__Sequence * lhs, const ros2srrc_data__action__Robmove_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2srrc_data__action__Robmove_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2srrc_data__action__Robmove_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2srrc_data__action__Robmove_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2srrc_data__action__Robmove_GetResult_Request * data =
      (ros2srrc_data__action__Robmove_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2srrc_data__action__Robmove_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2srrc_data__action__Robmove_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2srrc_data__action__Robmove_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2srrc_data__action__Robmove_GetResult_Response__init(ros2srrc_data__action__Robmove_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!ros2srrc_data__action__Robmove_Result__init(&msg->result)) {
    ros2srrc_data__action__Robmove_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
ros2srrc_data__action__Robmove_GetResult_Response__fini(ros2srrc_data__action__Robmove_GetResult_Response * msg)
{
  ...
  // status
  // result
  ros2srrc_data__action__Robmove_Result__fini(&msg->result);
}
...
ros2srrc_data__action__Robmove_GetResult_Response__are_equal(const ros2srrc_data__action__Robmove_GetResult_Response * lhs, const ros2srrc_data__action__Robmove_GetResult_Response * rhs)
{
  ...
  // result
  if (!ros2srrc_data__action__Robmove_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_GetResult_Response * msg = (ros2srrc_data__action__Robmove_GetResult_Response *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2srrc_data__action__Robmove_GetResult_Response));
  bool success = ros2srrc_data__action__Robmove_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_GetResult_Response__Sequence__init(ros2srrc_data__action__Robmove_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_GetResult_Response * data = NULL;

  if (size) {
    data = (ros2srrc_data__action__Robmove_GetResult_Response *)allocator.zero_allocate(size, sizeof(ros2srrc_data__action__Robmove_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2srrc_data__action__Robmove_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2srrc_data__action__Robmove_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2srrc_data__action__Robmove_GetResult_Response__Sequence__fini(ros2srrc_data__action__Robmove_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2srrc_data__action__Robmove_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_GetResult_Response__Sequence * array = (ros2srrc_data__action__Robmove_GetResult_Response__Sequence *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2srrc_data__action__Robmove_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_GetResult_Response__Sequence__destroy(ros2srrc_data__action__Robmove_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2srrc_data__action__Robmove_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2srrc_data__action__Robmove_GetResult_Response__Sequence__are_equal(const ros2srrc_data__action__Robmove_GetResult_Response__Sequence * lhs, const ros2srrc_data__action__Robmove_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2srrc_data__action__Robmove_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2srrc_data__action__Robmove_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2srrc_data__action__Robmove_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2srrc_data__action__Robmove_GetResult_Response * data =
      (ros2srrc_data__action__Robmove_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2srrc_data__action__Robmove_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2srrc_data__action__Robmove_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2srrc_data__action__Robmove_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2srrc_data__action__Robmove_FeedbackMessage__init(ros2srrc_data__action__Robmove_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ros2srrc_data__action__Robmove_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!ros2srrc_data__action__Robmove_Feedback__init(&msg->feedback)) {
    ros2srrc_data__action__Robmove_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
ros2srrc_data__action__Robmove_FeedbackMessage__fini(ros2srrc_data__action__Robmove_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  ros2srrc_data__action__Robmove_Feedback__fini(&msg->feedback);
}
...
ros2srrc_data__action__Robmove_FeedbackMessage__are_equal(const ros2srrc_data__action__Robmove_FeedbackMessage * lhs, const ros2srrc_data__action__Robmove_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!ros2srrc_data__action__Robmove_Feedback__are_equal(
      &(lhs->feedback), &(rhs->feedback)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_FeedbackMessage * msg = (ros2srrc_data__action__Robmove_FeedbackMessage *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2srrc_data__action__Robmove_FeedbackMessage));
  bool success = ros2srrc_data__action__Robmove_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_FeedbackMessage__Sequence__init(ros2srrc_data__action__Robmove_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_FeedbackMessage * data = NULL;

  if (size) {
    data = (ros2srrc_data__action__Robmove_FeedbackMessage *)allocator.zero_allocate(size, sizeof(ros2srrc_data__action__Robmove_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2srrc_data__action__Robmove_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2srrc_data__action__Robmove_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2srrc_data__action__Robmove_FeedbackMessage__Sequence__fini(ros2srrc_data__action__Robmove_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2srrc_data__action__Robmove_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2srrc_data__action__Robmove_FeedbackMessage__Sequence * array = (ros2srrc_data__action__Robmove_FeedbackMessage__Sequence *)allocator.allocate(sizeof(ros2srrc_data__action__Robmove_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2srrc_data__action__Robmove_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2srrc_data__action__Robmove_FeedbackMessage__Sequence__destroy(ros2srrc_data__action__Robmove_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2srrc_data__action__Robmove_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2srrc_data__action__Robmove_FeedbackMessage__Sequence__are_equal(const ros2srrc_data__action__Robmove_FeedbackMessage__Sequence * lhs, const ros2srrc_data__action__Robmove_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2srrc_data__action__Robmove_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2srrc_data__action__Robmove_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2srrc_data__action__Robmove_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2srrc_data__action__Robmove_FeedbackMessage * data =
      (ros2srrc_data__action__Robmove_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2srrc_data__action__Robmove_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2srrc_data__action__Robmove_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2srrc_data__action__Robmove_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
