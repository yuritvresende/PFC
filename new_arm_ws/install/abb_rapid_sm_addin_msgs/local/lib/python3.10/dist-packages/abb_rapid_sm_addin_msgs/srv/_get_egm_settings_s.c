...
bool abb_rapid_sm_addin_msgs__srv__get_egm_settings__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abb_rapid_sm_addin_msgs.srv._get_egm_settings.GetEGMSettings_Request", full_classname_dest, 68) == 0);
  }
  abb_rapid_sm_addin_msgs__srv__GetEGMSettings_Request * ros_message = _ros_message;
  {  // task
...
{
  /* NOTE(esteve): Call constructor of GetEGMSettings_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("abb_rapid_sm_addin_msgs.srv._get_egm_settings");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetEGMSettings_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool abb_rapid_sm_addin_msgs__srv__get_egm_settings__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abb_rapid_sm_addin_msgs.srv._get_egm_settings.GetEGMSettings_Response", full_classname_dest, 69) == 0);
  }
  abb_rapid_sm_addin_msgs__srv__GetEGMSettings_Response * ros_message = _ros_message;
  {  // settings
...
{
  /* NOTE(esteve): Call constructor of GetEGMSettings_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("abb_rapid_sm_addin_msgs.srv._get_egm_settings");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GetEGMSettings_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
