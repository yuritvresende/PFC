...
bool abb_robot_msgs__msg__rapid_symbol_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abb_robot_msgs.msg._rapid_symbol_path.RAPIDSymbolPath", full_classname_dest, 53) == 0);
  }
  abb_robot_msgs__msg__RAPIDSymbolPath * ros_message = _ros_message;
  {  // task
...
{
  /* NOTE(esteve): Call constructor of RAPIDSymbolPath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("abb_robot_msgs.msg._rapid_symbol_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RAPIDSymbolPath");
