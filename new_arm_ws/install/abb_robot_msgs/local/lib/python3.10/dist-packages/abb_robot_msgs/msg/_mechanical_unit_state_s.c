...
bool abb_robot_msgs__msg__mechanical_unit_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("abb_robot_msgs.msg._mechanical_unit_state.MechanicalUnitState", full_classname_dest, 61) == 0);
  }
  abb_robot_msgs__msg__MechanicalUnitState * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of MechanicalUnitState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("abb_robot_msgs.msg._mechanical_unit_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MechanicalUnitState");
