...
bool ros2_robotiqgripper__srv__robotiq_gripper__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_robotiqgripper.srv._robotiq_gripper.RobotiqGripper_Request", full_classname_dest, 63) == 0);
  }
  ros2_robotiqgripper__srv__RobotiqGripper_Request * ros_message = _ros_message;
  {  // action
...
{
  /* NOTE(esteve): Call constructor of RobotiqGripper_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_robotiqgripper.srv._robotiq_gripper");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotiqGripper_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool ros2_robotiqgripper__srv__robotiq_gripper__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros2_robotiqgripper.srv._robotiq_gripper.RobotiqGripper_Response", full_classname_dest, 64) == 0);
  }
  ros2_robotiqgripper__srv__RobotiqGripper_Response * ros_message = _ros_message;
  {  // success
  ...
  {  // average
    ...
    ros_message->average = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // message
...
{
  /* NOTE(esteve): Call constructor of RobotiqGripper_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros2_robotiqgripper.srv._robotiq_gripper");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotiqGripper_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
