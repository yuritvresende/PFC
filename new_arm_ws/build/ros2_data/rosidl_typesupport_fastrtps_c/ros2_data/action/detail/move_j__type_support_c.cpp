  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_data__action__MoveJ_Goal;
    is_plain =
      (
...
static size_t _MoveJ_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_data__action__MoveJ_Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_data__action__MoveJ_Result;
    is_plain =
      (
...
static size_t _MoveJ_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_data__action__MoveJ_Result(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_data__action__MoveJ_Feedback;
    is_plain =
      (
...
static size_t _MoveJ_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_data__action__MoveJ_Feedback(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_data__action__MoveJ_SendGoal_Request;
    is_plain =
      (
...
static size_t _MoveJ_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_data__action__MoveJ_SendGoal_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_data__action__MoveJ_SendGoal_Response;
    is_plain =
      (
...
static size_t _MoveJ_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_data__action__MoveJ_SendGoal_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_data__action__MoveJ_GetResult_Request;
    is_plain =
      (
...
static size_t _MoveJ_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_data__action__MoveJ_GetResult_Request(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_data__action__MoveJ_GetResult_Response;
    is_plain =
      (
      offsetof(DataType, result) +
      last_member_size
...
static size_t _MoveJ_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_data__action__MoveJ_GetResult_Response(
    full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_data__action__MoveJ_FeedbackMessage;
    is_plain =
      (
      offsetof(DataType, feedback) +
      last_member_size
...
static size_t _MoveJ_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_data__action__MoveJ_FeedbackMessage(
    full_bounded, is_plain, 0);
