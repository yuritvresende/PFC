...
#include "objectpose_msgs/msg/detail/object_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const objectpose_msgs::msg::ObjectPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<objectpose_msgs::msg::ObjectPose *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_objectpose_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<objectpose_msgs::msg::ObjectPose>()
{
  return &objectpose_msgs::msg::typesupport_fastrtps_cpp::_ObjectPose__handle;
}
