...
bool objectpose_msgs__msg__object_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("objectpose_msgs.msg._object_pose.ObjectPose", full_classname_dest, 43) == 0);
  }
  objectpose_msgs__msg__ObjectPose * ros_message = _ros_message;
  {  // objectname
    PyObject * field = PyObject_GetAttrString(_pymsg, "objectname");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->objectname, PyBytes_AS_STRING(encoded_field));
...
PyObject * objectpose_msgs__msg__object_pose__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("objectpose_msgs.msg._object_pose");
  ...
  {  // objectname
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->objectname.data,
      strlen(ros_message->objectname.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "objectname", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
