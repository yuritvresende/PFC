...
class Metaclass_ObjectPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('objectpose_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'objectpose_msgs.msg.ObjectPose')
            logger.debug(
...
class ObjectPose(metaclass=Metaclass_ObjectPose):
    ...
    def __init__(self, **kwargs):
        ...
        self.objectname = kwargs.get('objectname', str())
    ...
    def objectname(self, value):
        if __debug__:
            assert \
                ...
                "The 'objectname' field must be of type 'str'"
