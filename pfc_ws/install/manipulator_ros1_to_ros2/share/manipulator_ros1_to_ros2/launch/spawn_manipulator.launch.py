...
def generate_launch_description():
    ...
    gazebo_launch_file = os.path.join(
        get_package_share_directory('manipulator_ros1_to_ros2'), 'launch', 'start_world.launch.py')
    
    spawn_launch_file = os.path.join(
        get_package_share_directory('manipulator_ros1_to_ros2'), 'launch', 'mobile_manipulator_gazebo.launch.py')
        
    controller_launch_file = os.path.join(
       get_package_share_directory('manipulator_ros1_to_ros2'), 'launch', 'start_controller.launch.py')
