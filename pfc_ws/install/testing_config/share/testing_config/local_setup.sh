...
: ${AMENT_CURRENT_PREFIX:="/home/yuritvr/PFC/pfc_ws/install/testing_config"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/testing_config/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/testing_config/environment/path.sh"
