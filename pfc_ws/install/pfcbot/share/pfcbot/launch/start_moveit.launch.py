...
def generate_launch_description():
    ...
    move_group_launch_file = os.path.join(
        get_package_share_directory('pfcbot_moveit_config'), 'launch', 'move_group.launch.py')
    
    rviz_launch_file = os.path.join(
        get_package_share_directory('pfcbot_moveit_config'), 'launch', 'moveit_rviz.launch.py')
